...
const Missing = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    ...
    const data = {
      cpf, // CPF do desaparecido
      photo, // Foto em formato Blob
      fullName, // Nome completo
      birthDate, // Data de nascimento
      gender, // Gênero (Masculino ou Feminino)
      lastSeenLocation, // Última localização vista
      lastSeenDate, // Data da última vez vista
      city, // Cidade
      state, // Estado
      postalCode, // Código postal (8 caracteres)
      skinColor, // Cor da pele
      eyeColor, // Cor dos olhos
      characteristics, // Características
      hair, // Cabelo
      illness: hasIllness, // Se a pessoa tem alguma doença (booleano)
      illnessDescription: hasIllness ? illnessDescription : '', // Descrição da doença, se aplicável
      clothingWorn, // Roupas que a pessoa estava usando
      vehicle: wasDrivingChecked, // Se estava com um veículo (booleano)
      vehicleDescription: wasDrivingChecked ? vehicleDescription : '', // Descrição do veículo, se aplicável
      boDocument, // Documento do BO (em formato Blob)
      boVerified: 'Pending', // Status de verificação do BO (padrão 'Pending')
